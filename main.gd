...
@export var velRapidaMinima = 700
@export var velRapidaMinima2 = 710
@export var velDevagarMinima = 300
@export var velDevagarMinima2 = 310
# PARAMETROS INICIAIS DOS JOGADORES
@export var fase = 1
var score1 = 0
var score2 = 0
